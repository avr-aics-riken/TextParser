...
!
!** @file TextParser.f90
!*  @brief This file contains the library interface for Fortran.
...
integer function TP_READ_LOCAL(tp_ptr,file)
  ...
  TP_READ_LOCAL = TP_READ_LOCAL_FORT(tp_ptr,trim(file)//NULL)
...
real function TP_CONVERT_FLOAT(tp_ptr,value,ierror)
  ...
  TP_CONVERT_FLOAT = TP_CONVERT_FLOAT_FORT(tp_ptr,trim(value)//NULL,ierror)
  return
...
real*8 function TP_CONVERT_DOUBLE(tp_ptr,value,ierror)
  ...
  TP_CONVERT_DOUBLE = TP_CONVERT_DOUBLE_FORT(tp_ptr,trim(value)//NULL,ierror)
...
logical function TP_CONVERT_LOGICAL(tp_ptr,value,ierror)
  ...
  if (tmp == 1.0) TP_CONVERT_LOGICAL=.true.
...
integer function TP_GET_ITH_NODE_ORDER(tp_ptr,inode,node,order)
  ...
  TP_GET_ITH_NODE_ORDER = TP_GET_ITH_NODE_ORDER_FORT(tp_ptr,iinode,node,order)
...
integer function TP_GET_ITH_LEAF_ORDER(tp_ptr,ileaf,leaf,order)
  ...
  TP_GET_ITH_LEAF_ORDER = TP_GET_ITH_LEAF_ORDER_FORT(tp_ptr,iileaf,leaf,order)
...
integer function TP_GET_INSTANCE_SINGLETON(tp_ptr)
  ...
  return
end function TP_GET_INSTANCE_SINGLETON
...
integer function TP_CREATE_INSTANCE(tp_ptr)
  ...
  return
end function TP_CREATE_INSTANCE
...
integer function TP_DELETE_INSTANCE(tp_ptr)
  ...
  return
end function TP_DELETE_INSTANCE
