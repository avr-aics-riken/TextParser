...
int main(int argc, char* argv[])
{
  ...
  if ( scan_all_parameters("./tpp_examples/correct_basic_1.txt",tp_handle) ) return 1;
  if ( scan_all_parameters("./tpp_examples/correct_string_1.txt",tp_handle) ) return 1;
  if ( scan_all_parameters("./tpp_examples/correct_label_2.txt",tp_handle) ) return 1;
  if ( scan_all_parameters("./tpp_examples/correct_cond_10.txt",tp_handle) ) return 1;
  if ( scan_all_parameters("./tpp_examples/correct_cond_9.txt",tp_handle) ) return 1;
  //    printf("end main\n");
